...
public class TankMovement : MonoBehaviour
{
    ...
    private void EngineAudio()
    {
        ...
        {
            // Otherwise if the tank is moving and if the idling clip is playing...
    ...
    private void Turn()
    {
        ...
        // Determine the number of degrees to be turned based on the
        // input, speed and time between frames.
